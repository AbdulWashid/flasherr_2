...
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.buy-requests.show', $buyRequest->id) }}">Details</a></li>
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.buy-requests.update', $buyRequest->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $buyRequest->name) }}"
                                            required>
                                        @error('name')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" name="email" value="{{ old('email', $buyRequest->email) }}"
                                            required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('phone_number', $buyRequest->phone_number) }}" required>
                                        @error('phone_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('network_type') is-invalid @enderror"
                                            ...
                                            <option value="trc20"
                                                {{ old('network_type', $buyRequest->network_type) == 'trc20' ? 'selected' : '' }}>
                                                TRC20</option>
                                            <option value="bep20"
                                                {{ old('network_type', $buyRequest->network_type) == 'bep20' ? 'selected' : '' }}>
                                                BEP20</option>
                                            <option value="erc20"
                                                {{ old('network_type', $buyRequest->network_type) == 'erc20' ? 'selected' : '' }}>
                                                ERC20</option>
                                        </select>
                                        @error('network_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('wallet_address', $buyRequest->wallet_address) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                            ...
                                            value="{{ old('quantity', $buyRequest->quantity) }}" step="0.00000001"
                                            required>
                                        @error('quantity')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="pending"
                                            {{ old('status', $buyRequest->status) == 'pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="completed"
                                            {{ old('status', $buyRequest->status) == 'completed' ? 'selected' : '' }}>
                                            Completed</option>
                                        <option value="rejected"
                                            {{ old('status', $buyRequest->status) == 'rejected' ? 'selected' : '' }}>
                                            Rejected</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('admin.buy-requests.show', $buyRequest->id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $statusDropdown.on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            showAjaxAlert('Status updated to <strong>' + newStatus +
                                '</strong>', 'success');
                            originalStatus = newStatus; // Set new original status
                        } else {
                            showAjaxAlert('Error: ' + (response.message || 'Unknown error'),
                                'danger');
            ...
            `;
                ...
                var toast = new bootstrap.Toast($newAlert, {
                    delay: 5000
                }); // Show for 5 seconds
                toast.show();

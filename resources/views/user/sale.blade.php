                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('sale.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="wallet_address" id="wallet_address" value="{{ old('wallet_address') }}"
                                       class="form-control @error('wallet_address') is-invalid @enderror"
                                       placeholder="TRC20 Wallet Address" required>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="quantity" id="quantity" value="{{ old('quantity') }}" step="0.01" min="1"
                            ...
                            <div class="mb-4">
                                <label for="documents" class="form-label">Upload Identification Documents (KYC)</label>
                                <input type="file" name="documents[]" id="documents" multiple
                                       class="form-control @error('documents') is-invalid @enderror @error('documents.*') is-invalid @enderror">
                                <div class="form-text">Please upload images or PDFs of your ID for verification (e.g., Passport, Driver's License).</div>
                                @error('documents')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                @error('documents.*')
...
@push('scripts')
{{-- Bootstrap JS Bundle is required for components like dismissible alerts --}}
{{-- Make sure it's included in your master layout file --}}
@endpush

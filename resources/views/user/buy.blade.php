...
@section('content')
    ...
    <div class="page-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="text-white wow fadeInUp" data-wow-delay="0.2s">Explore <span class="text-line">USDT</span>
                            for Sale</h1>
        ...
        <!-- Sales Grid Section -->
        <section class="content-inner-2 coins-wrapper bg-light overflow-hidden pb-5">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    @forelse ($sales as $sale)
                        <div class="col-xl-4 col-md-6 m-b30 bordered">
                            <div class="icon-bx-wraper style-1 box-hover text-center wow fadeInUp"
                                data-wow-delay="0.{{ $loop->iteration + 1 }}s">
                    ...
                    @empty
                        ...
                        <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.6s">
                            <img src="{{ asset('user/images/no-data.png') }}" alt="No sales found" class="img-fluid m-b20"
